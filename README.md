...
# 📖 Shopify: Django Project <a name="about-project"></a>

**Shopify: Django Project** is a Shopify web application that uses Django to add and remove items. It is a simple but powerful project that illustrates my ability to work with python and web libraries.
